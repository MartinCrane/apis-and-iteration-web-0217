...
def get_film_urls(character_name)
  ...
  character_name_index = $global_name_array.index(character_name)
  $global_character_hash["results"][character_name_index]["films"]
end

def name_existence_test(character_name)  
  $global_name_array.include?(character_name)
end
...
def runner(character)
  film_array = get_film_urls(character)
